...
def create_map(latitude, longitude, radius, icon, labels_in_local_lang):
...
@app.route('/map-picture', methods=['GET'])
def get_map_picture():
    ...
    create_map(latitude, longitude, radius, icon, labels_in_local_lang)
